...
class Discussion(object):
    ...
    """
    def __init__(self, discussion_id=None, user=None, subject=None, description=None, creation_time=None, sentiment=None, sentiment_details=None, sentiment_weightage=None, entity=None):
        """
